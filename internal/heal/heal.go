...
var gitignoreLines = []string{"/modules/default.nix", "/modules/system", "/modules/local", "/local", "/.local/machines/*/hardware"}
...
func Run(w io.Writer, p paths.Paths, host string, prune bool) error {
	...
	fmt.Fprintf(w, "Ensuring local/hardware -> .local/hardware/%s link...\n", key)
